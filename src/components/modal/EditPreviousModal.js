...
export default {
    ...
    template: /*html*/`
        <div>
            <transition enter-active-class='animate__animated animate__fadeIn animate__faster' leave-active-class='animate__animated animate__fadeOut animate__faster' mode="out-in">
                <Modal v-if="showEditPreviousModal" @close="closeModal" >
                ...
                <h4 class='text-center mb-2'> Update</h4>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="start" name="trip-start" type="text" v-model="size" style="height:130px" class="form-control"></textarea>
                    </div> 
                   ...
                   <button class='btn btn-info d-block m-auto' @click.prevent="onSubmit">Edit</button>
    ...
    computed: {
        showEditPreviousModal() {
            return this.$store.getters.showEditPreviousModal
        },
    ...
    methods: {
        closeModal() {
            this.$store.dispatch('setEditPreviousModal', false)
        },
        ...
        onSubmit() {
             ...
             $.post(API + 'backend/api.php', {command: 'updatePrevious',id:this.id,site_id:this.site_id,site_name:this.site_name, last_update_number:this.last_update_number , date_sent:this.date_sent,update_description:this.update_description,comment:this.comment,size:this.size}, (data) => {
                ...
                getDevelopments()
                 ...
                 setTimeout(() => {
                    $.post(API + 'backend/api.php', {command: 'getSite',  id:this.id,site_id:this.site_id,site_name:this.site_name}, (data) => {
